 ...
 */
public class VisualizarOutubro extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_visualizar_outubro, container, false);
        TextQ1 = (TextView) view.findViewById(R.id.textViewQuantidadeOutubro1);
        TextVdespesa = (TextView) view.findViewById(R.id.textViewVTOutubro1);
        TextQ2 = (TextView) view.findViewById(R.id.textView11QuantOutubro);
        TextVdespesa2 = (TextView) view.findViewById(R.id.textView12VToutubro);
        TextQInvestimento = (TextView) view.findViewById(R.id.textView16QuantiOutubro);
        TextValorInvestimento = (TextView) view.findViewById(R.id.textView17VTOutubro);
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            for (int i =0; i < despesas.size(); i++) {
                ...
                if (d.getDataVencimento().get(Calendar.MONTH) == Calendar.OCTOBER) {
            ...
            for (int i=0; i <investimentos.size(); i++) {
                ...
                if(investimento.getVencimentoInvestimento().get(Calendar.MONTH) == Calendar.OCTOBER) {
