 ...
 */
public class VisualizarSetembro extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_visualizar_setembro, container, false);
        TextQ1 = (TextView) view.findViewById(R.id.textViewquantSetembro);
        TextVdespesa = (TextView) view.findViewById(R.id.textViewVT1Setembro);
        TextQ2 = (TextView) view.findViewById(R.id.textViewQyantidadaeSetembro2);
        TextVdespesa2 = (TextView) view.findViewById(R.id.textViewVTSetembro2);
        TextQInvestimento = (TextView) view.findViewById(R.id.textView17QuantidadeSetembro);
        TextValorInvestimento = (TextView) view.findViewById(R.id.textView18VTInvestimento);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            for (int i =0; i < despesas.size(); i++) {
                ...
                if (d.getDataVencimento().get(Calendar.MONTH) == Calendar.SEPTEMBER) {
            ...
            for (int i=0; i <investimentos.size(); i++) {
                ...
                if(investimento.getVencimentoInvestimento().get(Calendar.MONTH) == Calendar.SEPTEMBER) {
