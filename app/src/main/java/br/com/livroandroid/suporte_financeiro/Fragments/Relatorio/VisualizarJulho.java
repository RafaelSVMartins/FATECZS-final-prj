 ...
 */
public class VisualizarJulho extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_visualizar_julho, container, false);
        TextQ1 = (TextView) view.findViewById(R.id.textViewQuantJulho);
        TextVdespesa = (TextView) view.findViewById(R.id.textViewVTJulho1);
        TextQ2 = (TextView) view.findViewById(R.id.textViewQuant2Julho);
        TextVdespesa2 = (TextView) view.findViewById(R.id.textViewVT3Julho);
        TextQInvestimento = (TextView) view.findViewById(R.id.textViewQuantInvestimentoJulho);
        TextValorInvestimento = (TextView) view.findViewById(R.id.textViewVTJulho4);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            for (int i =0; i < despesas.size(); i++) {
                ...
                if (d.getDataVencimento().get(Calendar.MONTH) == Calendar.JULY) {
            ...
            for (int i=0; i <investimentos.size(); i++) {
                ...
                if(investimento.getVencimentoInvestimento().get(Calendar.MONTH) == Calendar.JULY) {
