 ...
 */
public class VisualizarJunho extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_visualizar_junho, container, false);
        TextQ1 = (TextView) view.findViewById(R.id.textViewQuantJunho);
        TextVdespesa = (TextView) view.findViewById(R.id.textViewTotalJunho);
        TextQ2 = (TextView) view.findViewById(R.id.textViewQuLJunho);
        TextVdespesa2 = (TextView) view.findViewById(R.id.textViewVTJunho);
        TextQInvestimento = (TextView) view.findViewById(R.id.textViewQuantInvestimentoJunho);
        TextValorInvestimento = (TextView) view.findViewById(R.id.textViewVTInvestimentoJunho);
        return view;
    }
