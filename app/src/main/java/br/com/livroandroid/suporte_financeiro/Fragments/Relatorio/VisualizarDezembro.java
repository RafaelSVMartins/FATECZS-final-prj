 ...
 */
public class VisualizarDezembro extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_visualizar_dezembro, container, false);
        TextQ1 = (TextView) view.findViewById(R.id.textView6);
        TextVdespesa = (TextView) view.findViewById(R.id.textView7VTDezembro);
        TextQ2 = (TextView) view.findViewById(R.id.textView11QuantidadeDezembro);
        TextVdespesa2 = (TextView) view.findViewById(R.id.textView12VTDezembro);
        TextQInvestimento = (TextView) view.findViewById(R.id.textView16QuantDezembro);
        TextValorInvestimento = (TextView) view.findViewById(R.id.textView17VTDezembro);
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            for (int i=0; i <investimentos.size(); i++) {
                ...
                if(investimento.getVencimentoInvestimento().get(Calendar.MONTH) == Calendar.DECEMBER) {
