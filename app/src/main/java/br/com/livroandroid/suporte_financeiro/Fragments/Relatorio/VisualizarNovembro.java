 ...
 */
public class VisualizarNovembro extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_visualizar_novembro, container, false);
        TextQ1 = (TextView) view.findViewById(R.id.textView6QuantidadeNovembro);
        TextVdespesa = (TextView) view.findViewById(R.id.textView7VTNovembro);
        TextQ2 = (TextView) view.findViewById(R.id.textView11QuantidadeNovembro);
        TextVdespesa2 = (TextView) view.findViewById(R.id.textView12VTNovembro);
        TextQInvestimento = (TextView) view.findViewById(R.id.textView16quantNovembro);
        TextValorInvestimento = (TextView) view.findViewById(R.id.textView17VTNovembro);
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            for (int i =0; i < despesas.size(); i++) {
                ...
                if (d.getDataVencimento().get(Calendar.MONTH) == Calendar.DECEMBER) {
            ...
            for (int i=0; i <investimentos.size(); i++) {
                ...
                if(investimento.getVencimentoInvestimento().get(Calendar.MONTH) == Calendar.NOVEMBER) {
